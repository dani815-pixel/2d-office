...
export default function TradingRoom({ market, brief, meetingStatus, meetingId }: { market: MarketSnapshot; brief?: CryptoMarketBrief; meetingStatus: MeetingState["status"]; meetingId?: string }) {
  ...
  return <div className="standard-page trading-page">
    <div className="page-head trading-page-head"><div><div className="eyebrow"><span className="eyebrow-line" />06 / TRADING DESK</div><h1>Trading <em>room.</em></h1><p>회의 가설을 검토하고 로컬 가상 포지션을 운용합니다.</p></div><div className="trading-page-head__actions"><span>LOCAL STATE</span></div></div>
